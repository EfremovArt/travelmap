...
/// Вкладка с избранными постами пользователя
...
class _FavoritesTabState extends State<FavoritesTab> {
  // Локальный список избранных постов
  ...
  Future<void> _favoritePost(Post post) async {
    try {
      ...
      // Обновляем список избранных постов
      _loadFavoritePosts();
    } catch (e) {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Добавляйте посты в избранное, чтобы они отображались здесь',
          ...
          return FutureBuilder<bool>(
            ...
            builder: (context, snapshot) {
              ...
              return PostCard(
                ...
                onEditPost: (_) {}, // Пустой обработчик, так как в избранном нельзя редактировать
                onDeletePost: (_) {}, // Пустой обработчик, так как в избранном нельзя удалять
